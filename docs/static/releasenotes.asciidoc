...
* Fix regression in `exclude` handling. Patterns are matched against the filename, not full path https://github.com/logstash-plugins/logstash-input-file/issues/237[#237]
