...
---------- DELETE FROM HERE ------------
=== Logstash Pull Requests with label v7.6.1

=== Logstash Commits between 7.6 and 7.6.0

Computed with "git log --pretty=format:'%h -%d %s (%cr) <%an>' --abbrev-commit --date=relative v7.6.0..7.6"

1bf5c55b9 - (HEAD -> 7.6, origin/7.6) Update patch plugin versions in gemfile lock for 7.6.1 (#11627) (16 hours ago) <Logstash Machine>
5ff66f1d4 - Remove deprecation notice (#11625) (17 hours ago) <Karen Metts>
15fe79f3d - update jruby-openssl license notice (#11618) (5 days ago) <Ry Biesemeyer>
3e380c3dc - Update contributing guidelines to clarify changelog formatting (6 days ago) <Karen Metts>
d57280ccc - Rework ls netflow module deprecation notice (7 days ago) <Karen Metts>
64e5e8185 - [DOC]Clarify internal collectors deprecation status for 7.6 (#11607) (8 days ago) <Karen Metts>
a79e2dfea - Fix setting name for monitoring (2 weeks ago) <Karen Metts>
d5fc79814 - Version bump to 7.6.1 (#11594) (2 weeks ago) <Rob Bavey>
a30cdfeba - Release notes for 7.6.0 (2 weeks ago) <Rob Bavey>
0bf1133dd - Clarify wording and add to another page (3 weeks ago) <Karen Metts>
0c14e0a7e - Add Apple notarization info (3 weeks ago) <Karen Metts>

=== Logstash Plugin Release Changelogs ===
Computed from "git diff v7.6.0..7.6 *.release"
Changed plugin versions:
logstash-filter-dns: 3.1.3 -> 3.1.4
logstash-filter-memcached: 1.0.1 -> 1.0.2
logstash-filter-split: 3.1.7 -> 3.1.8
logstash-input-beats: 6.0.4 -> 6.0.8
logstash-input-file: 4.1.12 -> 4.1.16
logstash-integration-jdbc: 5.0.0 -> 5.0.1
logstash-output-elasticsearch: 10.3.0 -> 10.3.1
---------- DELETE UP TO HERE ------------
